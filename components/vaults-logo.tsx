type VaultsLogoP = {
  variant: "full" | "small" | "tiny";
} & React.HTMLAttributes<SVGSVGElement>;

function TinyLogo(props: React.HTMLAttributes<SVGSVGElement>) {
  return (
    <svg
...
function SmallLogo(props: React.HTMLAttributes<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
function FullLogo(props: React.HTMLAttributes<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 152 34"
...
export default function VaultsLogo({ variant, ...rest }: VaultsLogoP) {
  if (variant === "full") {
    return <FullLogo {...rest} />;
  }

  if (variant === "small") {
    return <SmallLogo {...rest} />;
  }

  if (variant === "tiny") {
    return <TinyLogo {...rest} />;
  }
