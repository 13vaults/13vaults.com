...
export default function Label<T extends React.ElementType = "p">({
  ...
  const variantStyleMap: Record<LabelVariant, string> = {
    ...
    "title-large": "text-3xl font-bold font-serif",
    title: "text-2xl font-bold font-serif tracking-tight",
    "title-small": "text-xl font-bold font-serif tracking-tighter",
    "label-large": "text-xl font-sans-sc font-bold",
    label: "text-lg font-sans-sc font-medium tracking-tight",
    "label-small": "text-base font-sans-sc font-medium tracking-tighter",
