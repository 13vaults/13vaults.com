...
export default function VaultLayout({
  ...
  return (
    <BasicLayout navigation={navigation}>
      <div className="bg-stone-900 px-4 lg:px-8 sticky top-14 z-0 shadow">
      ...
      <div className="p-4 lg:p-8">
        <Container className="grid grid-cols-1 gap-6 xl:grid-cols-12 relative">
          ...
          <main className="xl:col-start-4 xl:col-end-13">
            <article
              className="prose prose-h1:my-0 prose-h2:mt-4 prose-p:text-justify max-w-none z-[-1] relative
