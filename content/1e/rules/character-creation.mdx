...
Constitution represents your character’s toughness and endurance. A Constitution bonus increases a character’s hit points, so the ability is important for all classes (except [necromancers][/compendium/classes/necromancer]).
